...
2. **Be versed in elementary mathematical ecology**, which includes:
	3. 0**Understanding ecological topics** on single-species population dynamics, structured population dynamics, spatial dynamics, two-species population dynamics, and multi-species dynamics.
	4. **Understanding and applying mathematical/analytical tools and topics** include equilibrium, stability, chaos, and stochasticity.
